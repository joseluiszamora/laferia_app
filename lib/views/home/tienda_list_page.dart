...
class TiendaListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _TiendaListPageContent(),
    );
  }
}

class _TiendaListPageContent extends StatelessWidget {
  const _TiendaListPageContent();
